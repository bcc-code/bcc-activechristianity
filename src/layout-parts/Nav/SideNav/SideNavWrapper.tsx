	...
	return (
		<motion.div
			...
			className={`drawer-side ${
				isSideNavOpen ? 'drawer-side-open' : 'drawer-side-close'
			} drawer-side-submenu bg-ac-slate-lighter w-full h-full flex flex-col justify-between xs:w-mobile xs:left-auto xs:shadow overflow-y-scroll fixed top-0 right-0 bottom-0 `}
		>
			<div className="min-h-12 h-12 w-full border-b border-d4slate-light p-4">
				...
				{close && (
					<div className=" cursor-pointer absolute right-0 top-0 p-3" onClick={close} onKeyDown={close}>
