...
const RecommendedPostsSection: React.FC<{ postId: string; readMorePosts: string[]; topics?: ITopicPostSlugs[] }> = ({
	postId,
	readMorePosts,
	topics
}) => {
	...
	return (
		<div className="pt-6">
			<FetchPostsFromSlugs
				...
				render={({ posts }) => {
					return <Row3ColAndXScroll title={`${ac_strings.you_might_be_interested_in}`} posts={posts} />;
				}}
			/>
