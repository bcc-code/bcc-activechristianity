...
const TaxonomyPage: React.FC<ITaxonomyPageProps> = props => {
	...
	const currentPage =
		typeof pageNrQuery === 'number' && pageNrQuery <= paginate.totalPages && pageNrQuery > 1 ? pageNrQuery : 1;
	return (
		<div className="mx-auto max-w-sm sm:p-0">
			<MetaTag type="page" title={title} translatedUrls={[]} breadcrumb={breadcrumb} path={pagePath} />
