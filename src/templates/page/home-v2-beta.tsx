					...
					{Object.keys(formats.formatIds).map(item => {
						...
						return (
							<div className="rounded overflow-hidden shadow">
								...
								<h3
									className="border-d4slate-dark font-bold text-center"
									style={{ padding: '12px 25px 12px 25px', fontSize: '21px' }}
								>
									{format.name}
								</h3>
...
const animationPosts = [
	'bible-words-explained-what-is-the-lust-of-the-flesh-video',
	'bible-quotes-explained-the-temple-old-testament-vs-new-testament',
	'bible-quotes-explained-put-off-the-old-man-put-on-the-new-man',
	'being-humble-an-important-reason-to-pursue-humility'
];

const articlesFromPillarsCollections = [
	'johan-o-smith-article',
	'elias-aslaksen-articles',
	'aksel-j-smith-articles',
	'sigurd-bratlie-articles'
];
...
const podcastPlaylists = [
	...
	'parables-series-podcast',
	'what-does-the-bible-say-podcast',
	'living-the-gospel-podcast-playlist'
];
const topicalPlaylsits = [
	'becoming-a-disciple-audio-articles-playlist',
	'faith-audio-articles-playlist',
	'youth-audio-articles-playlist',
	'freedom-from-sin-audio-articles-playlist',
	'important-concepts-audio-articles-playlist'
];
