...
const Ebook: React.FC<IEbook> = ebook => {
	...
	const ebookDownload = <EbookDownload title={title} id={id} languageOptions={languageOptions} previewImages={[]} />;
	...
	return (
		<article className="overflow-scroll px-4">
			<div className="flex flex-col sm:flex-row">
				<div className=" w-full lg:w-4/12 py-4 flex pl  -4">{desktopCover}</div>
