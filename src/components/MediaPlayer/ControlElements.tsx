    ...
    return (
        <div className="volume-bar flex">
            ...
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clip-rule="evenodd" d="M11.5 0.792847V1.99995V18V19.2071L10.6464 18.3535L5.79289 13.5H1H0.5V13V6.99995V6.49995H1H5.79289L10.6464 1.6464L11.5 0.792847ZM10.5 3.20706L6.35355 7.35351L6.20711 7.49995H6H1.5V12.5H6H6.20711L6.35355 12.6464L10.5 16.7928V3.20706ZM15.5 9.99991C15.5 8.36974 14.3851 6.99871 12.8754 6.61015L13.1246 5.64171C15.0654 6.14123 16.5 7.90241 16.5 9.99991C16.5 12.0974 15.0654 13.8586 13.1246 14.3581L12.8754 13.3897C14.3851 13.0011 15.5 11.6301 15.5 9.99991ZM13.8574 3.7691C16.5427 4.56828 18.5 7.05621 18.5 9.99999C18.5 12.9438 16.5427 15.4317 13.8574 16.2309L14.1426 17.1893C17.2403 16.2674 19.5 13.3983 19.5 9.99999C19.5 6.60173 17.2403 3.73256 14.1426 2.81064L13.8574 3.7691Z" fill="#9CA6BE" />
            </svg>
