...
const ShareIconPopper: React.FC<IProps> = ({ shareUrl, placement, text, title, offSetBottom }) => {
	...
	return (
		<>
			<div className="bg-ac-slate-dark text-white rounded-lg px-2">
				<div className="flex">
					...
					<TelegramShareButton url={options.shareUrl} title={shareContent}>
						<TelegramIcon {...IconProps} />
					</TelegramShareButton>
					<EmailShareButton url={options.shareUrl} subject={title} body={text}>
						<EmailIcon {...IconProps} />
					</EmailShareButton>
				</div>
