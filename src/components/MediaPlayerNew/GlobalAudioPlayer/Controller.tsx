...
import { isAutoPlaySelector } from '@/state/selectors/other';
				...
				<div className="sm:hidden ">
					{fullScreenInfo ? (
						...
						<div className="w-full bg-gray-300">
							<div className="h-1 bg-ac-slate-light" style={{ width: `${played * 100}%` }}></div>
						</div>
					)}
				</div>
					...
					{fullScreenInfo ? (
						<div className="sm:hidden flex">
							<button className="flex items-center">
								<PrevTrack className="p-3" onClick={onPrevTrack} />
							</button>
							{playPauseControl}
							<button className="flex items-center">
								<NextTrack className="p-3" onClick={onNextTrack} />
							</button>
						</div>
					) : (
						<div className="flex max-w-tablet mx-auto items-center w-full">
							<div className="sm:hidden">{playPauseControl}</div>
